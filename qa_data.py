...
def process_glove(args, vocab_list, save_path, size=4e5, random_init=True):
    ...
    if not gfile.Exists(save_path + ".npz"):
        ...
        glove_path = os.path.join(args.glove_dir, "sgns.merge.word")
        if random_init:
...
if __name__ == '__main__':
    ...
    train_path = pjoin(args.source_dir, "/data_train")
    ...
    process_glove(args, rev_vocab, args.source_dir + "sgns.merge.word",
