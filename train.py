...
tf.app.flags.DEFINE_integer("batch_size", 23, "Batch size to use during training.")
...
tf.app.flags.DEFINE_integer("question_size",18, "The output size of your question.")#length of question
tf.app.flags.DEFINE_integer("output_size", 18, "The output size of your model.")#length of passage
